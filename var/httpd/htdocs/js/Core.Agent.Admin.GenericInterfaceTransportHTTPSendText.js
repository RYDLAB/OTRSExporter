...
/**
 * @namespace Core.Agent.Admin.GenericInterfaceTransportHTTPSendText
 * @memberof Core.Agent.Admin
 * @author OTRS AG
 * @description
 *      This namespace contains the special module functions for the GenericInterface Mapping XSLT module.
 */
Core.Agent.Admin.GenericInterfaceTransportHTTPSendText = (function (TargetNS) {

    /**
     * @name RemoveValue
     * @memberof Core.Agent.Admin.GenericInterfaceTransportHTTPSendText
     * @function
    ...
    return TargetNS;
}(Core.Agent.Admin.GenericInterfaceTransportHTTPSendText || {}));
